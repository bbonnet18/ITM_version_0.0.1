...
NSString * const YAMMER_AUTH_REDIRECT_URI = @"itmgo://com.itmgo.oauthscheme.returncode";

// Put your Yammer App's Client ID here
NSString * const YAMMER_APP_CLIENT_ID = @"dbvrSPKPKOgBPDu9zBx5qQ";
...
NSString * const YAMMER_APP_CLIENT_SECRET = @"un8jmLIukEEomaqSAAWrZyJZzn4SoXKGVuZx9740";
